...
TRAIN_SCRIPT='/home/ubuntu/varuna_examples/DeepLearningExamples/PyTorch/LanguageModeling/BERT/scripts/pretrain_varuna.sh'
...
# profile script
cmd="bash /home/ubuntu/varuna_examples/DeepLearningExamples/PyTorch/LanguageModeling/BERT/scripts/profile_varuna.sh"
# echo ${cmd}
# eval ${cmd}
